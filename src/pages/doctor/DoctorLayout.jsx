        ...
        <div className="topbar">
          ...
          <div style={{ display: 'flex', alignItems: 'center', gap: 10 }}>
            ...
            <div style={{ position: 'relative' }}>
              ...
              {showNotif && (
                <div style={{ position: 'absolute', right: 0, top: 48, width: 320, background: '#fff', border: '1px solid #e4eaf5', borderRadius: 16, boxShadow: '0 8px 32px rgba(15,23,42,0.12)', zIndex: 300, overflow: 'hidden' }}>
